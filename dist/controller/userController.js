...
const register = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    password = crypto_js_1.default.AES.encrypt(password, 'secret key 123').toString();
...
const login = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const validPassword = crypto_js_1.default.AES.decrypt(user.password, 'secret key 123').toString(crypto_js_1.default.enc.Utf8);
    if (!validPassword) {
